...
var logger = require('./loggerutil')('%c[Mojang]', 'color: #a02d2a; font-weight: bold');
// Constants
var minecraftAgent = {
    name: 'Minecraft',
    version: 1
};
var authpath = 'https://authserver.mojang.com';
var statuses = [
    {
        ...
        request.get('https://status.mojang.com/check', {
            ...
            if (error || response.statusCode !== 200) {
                ...
                for (var i = 0; i < body.length; i++) {
                    ...
                    inner: for (var j = 0; j < statuses.length; j++) {
 ...
 */
exports.authenticate = function (username, password, clientToken, requestUser, agent) {
    if (requestUser === void 0) { requestUser = true; }
    if (agent === void 0) { agent = minecraftAgent; }
    return new Promise(function (resolve, reject) {
        var body = {
            agent: agent,
            username: username,
 ...
 */
exports.refresh = function (accessToken, clientToken, requestUser) {
    if (requestUser === void 0) { requestUser = true; }
    return new Promise(function (resolve, reject) {
